...
export const theme: Types.Theme = {
  additionalStyles: {
    Button: {
      ...
      '--n-10': 'var(--n-0)',
      background:
        'linear-gradient(135deg, light-dark(#0891b2, #06b6d4) 0%, light-dark(#0d9488, #14b8a6) 100%)',
